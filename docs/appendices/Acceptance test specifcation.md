...
\begin{tabularx}{\textwidth}{| c |*{3}{X|} c |}
    ...
    \hline
    \textbf{2} & Open the Terminal UI  & A message saying "Choose the rooms for this route" and a list of all rooms appear on the UI. A finish and clear option appear as well & & \\ 
    \hline
    \textbf{3} & Choose room 1, 2, and 3 & Room 1, 2 and 3 are marked & & \\
    \hline
    \textbf{4} & Navigate to and select 'Finish' & A confirmation message saying "These are your chosen rooms" and a list of the chosen rooms appears & & \\
    \hline
    \textbf{5} & 'Confirm' is selected & [Wireshark] A route is sent to the server & & \\ 
    \hline
    \textbf{6} & Open the text file "logger.txt" on the server and check the contents & The file contains the list of selected rooms (1, 2 and 3) & & \\
    \hline
...
\begin{tabularx}{\textwidth}{| c |*{3}{X|} c |}
    ...
    \textbf{No.} & \textbf{Action} & \textbf{Expected result} & \textbf{Actual result} & \textbf{(OK/FAIL)}\\
    \hline
    \textbf{1} & Open the Terminal UI  & A message saying "Choose the rooms for this route" and a list of all rooms appear on the UI. A finish and clear option appear as well & & \\ 
    \hline
    \textbf{2} & Choose room 1, 2, and 3 & Room 1, 2 and 3 are marked & & \\
    \hline
    \textbf{3} & Navigate to and select 'Clear' & All rooms are deselected & & \\
    \hline
\end{tabularx}
...
\begin{tabularx}{\textwidth}{| c |*{3}{X|} c |}
    ...
    \hline
    \textbf{4} & 'Deny' is selected & Popup closes. & & \\ 
    \hline
\end{tabularx}
