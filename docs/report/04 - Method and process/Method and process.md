...
This is very visable in the insight profiles as provided in the appendix, where most of the group is blue green-ish coordinaters. Due to the massive overload of coordinaters and supporters a very tight collaboration contract which can be found under the appendix. This contract was made with the goal in mind of always keeping busy and asking for help when needs be, a big part of it was to help lift up eachother and make sure everyone had the oppertunity to touch some code. Aswell as in sure people showed up for meetings and work hours.
