...
## Improvements
The project finalized into a prototype, a proof of concept before making it into actual hospitals, hence why a lot of improvements could be made to it.
